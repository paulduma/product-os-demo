...
## Other notes (raw) to sort

Le playbook =
- Le set up (getting started) -> expliquer à des PM comment créer leur skills en deux layers: 
(1 simple - skills in app - et 1 complex - os connexion)
- Personnalization: idem, expliquer comment passer de mon repo avec plein de skills vers un set up perso
