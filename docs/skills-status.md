...
> 👁️ Dépôt de démo — seuls les 4 skills ci-dessous sont présents (`create-skill`, `init-project`, `write-spec`, `benchmark`). Le reste du système (Meta, Code, Product, Pro) vit dans la version privée.
